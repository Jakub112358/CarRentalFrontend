export enum ApiConstraints {
  ...
  CLIENT_URL = 'http://localhost:8080/api/v1/clients',
  RESERVATION_URL = 'http://localhost:8080/api/v1/reservations',
  PICK_UP_URL = 'http://localhost:8080/api/v1/pick-ups',
  CAR_RETURN_URL = 'http://localhost:8080/api/v1/car-returns',
  PRICE_LIST_URL = 'http://localhost:8080/api/v1/pricelists',
